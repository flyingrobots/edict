...
fn run() -> Result<(), String> {
    ...
    match args.next().as_deref() {
        ...
        None => Err(
            "usage: cargo xtask <verify|contract-check|release-dates|authority-facts-goldens|target-profile-resource-goldens|core-goldens|bundle-goldens|cli-goldens|target-ir-goldens|provider-component-fixtures|provider-contract-pack|provider-runtime-dependencies|release-prep>"
                .into(),
        ),
    }
}
