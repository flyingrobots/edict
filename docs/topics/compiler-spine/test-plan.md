...
| CSPINE-REQ-006 | implemented | The first lowerable subset covers `bounded-hello` style pure local-record actions and rejects out-of-subset constructs structurally. | fixtures/lang/bounds/bounded-hello.edict, issue #20 |
