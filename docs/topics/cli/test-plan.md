...
| CLI-TP-031 | implemented | External-action refusal | CLI-REQ-016 | Missing requests, callable-step mixtures, substituted capability manifests, and failed pair replacement refuse before a passing publication witness. | external_action_build_requires_a_typed_request, external_action_build_rejects_mixed_callable_execution, public_external_action_build_rejects_capability_substitution, failed_external_action_pair_publication_preserves_previous_core | crates/edict-cli/src/application_build.rs | Stable failure kinds distinguish closure, execution-class, and output failures. |
