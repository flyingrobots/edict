...
| TIR-TP-031 | planned | Integration | TIR-REQ-001, TIR-REQ-015 | Compiling and lowering the operation prerequisite fixture preserves the exact Core basis expression and binds the computed Core digest plus exact lawpack coordinate/digest in Target IR. | operation_prerequisite_fixture_preserves_fixed_width_basis_and_lawpack_closure | fixtures/lang/operations/explicit-basis-u64.edict | The target artifact binds semantic inputs but remains distinct from package admission or runtime execution. |
| TIR-TP-032 | planned | Mutation sensitivity | TIR-REQ-008, TIR-REQ-015 | Changing the basis expression, source Core meaning, lawpack coordinate, or lawpack digest moves the Target IR digest. | explicit_basis_and_semantic_input_mutations_move_target_identity | fixtures/lang/operations/explicit-basis-u64.edict | Prevents Target IR identity from floating over operation semantic inputs. |
